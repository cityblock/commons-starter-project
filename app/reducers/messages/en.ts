...
export const ENGLISH_TRANSLATION = {
  ...
  messages: {
    ...
    'patientCalendar.addEvent': 'Add appointment',
    'patientCalendar.viewGoogleCalender': 'View Google calendar',
    'patientAppointmentModal.title': 'Add an appointment',
    'patientAppointmentModal.subtitle':
      'This will create the beginning of a Google calendar event for the patient',
    'patientAppointmentModal.submit': 'Create appointment',
    'patientAppointmentModal.cancel': 'Cancel',
    'patientAppointmentModal.appointmentTitle': 'Appointment name',
    'patientAppointmentModal.reason': 'Reason for the appointment',
    'patientAppointmentModal.invitee': 'Select care team member for the appointment',
