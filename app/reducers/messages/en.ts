...
export const ENGLISH_TRANSLATION = {
  ...
  messages: {
    ...
    'externalProvider.substanceUseCounselor': 'Substance use counselor',
    'externalProvider.therapistMentalHealth': 'Therapist (mental health)',
    'externalProvider.therapistPhysical': 'Therapist (physical, occupational)',
    'externalProvider.psychiatrist': 'Psychiatrist',
    'externalProvider.urology': 'Urology',
    'externalProvider.endocrinology': 'Endocrinology',
    'externalProvider.ophthalmology': 'Ophthalmology',
    'externalProvider.cardiology': 'Cardiology',
    'externalProvider.podiatry': 'Podiatry',
    'externalProvider.orthopedics': 'Orthopedics',
    'externalProvider.infectiousDisease': 'Infectious Disease',
    'externalProvider.obgyn': 'OBGYN',
    'externalProvider.pulmonology': 'Pulmonology',
    'externalProvider.nephrology': 'Nephrology',
    'externalProvider.hepatology': 'Hepatology',
    'externalProvider.gastroenterology': 'Gastroenterology',
    'externalProvider.ent': 'ENT',
    'externalProvider.vascular': 'Vascular',
    'externalProvider.oncology': 'Oncology',
    'externalProvider.hematology': 'Hematology',
    'externalProvider.dermatology': 'Dermatology',
    'externalProvider.dialysis': 'Dialysis provider (RN, SW)',
    'externalProvider.housingCaseManager': 'Housing case manager',
    'externalProvider.hasaCaseManager': 'HASA case manager',
    'externalProvider.pharmacy': 'Pharmacy',
    'externalProvider.homeAttendant': 'Home attendant provider',
    'externalProvider.visitingNurse': 'Visiting nurse service provider',
    'externalProvider.durableMedicalEquipment': 'Durable medical equipment provider',
    'externalProvider.healthHomeCareManager': 'Health home care manager',
    'externalProvider.insurancePlanCareManager': 'Insurance plan care manager',
    'externalProvider.otherCaseManagement': 'Other case management',
    'externalProvider.formalCaregiver': 'Formal caregiver',
    'externalProviderSelect.other': 'Other',
    'externalProviderSelect.otherMedicalSpecialty': 'Other medical specialist',
    'externalProviderSelect.medicalSpecialist': 'Medical specialist',
    'externalProviderSelect.placeholder': 'Select the provider role',
    ...
    'patientTeam.externalTeamEmptyTitle': 'No one has been added to this member\'s external care team',
    'patientTeam.externalTeamEmptyDetail': 'Add anyone that is providing care for this member that is not on their Cityblock care team.',
