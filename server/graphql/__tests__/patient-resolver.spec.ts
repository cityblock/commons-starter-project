...
import getPatientPanel from '../../../app/graphql/queries/get-patient-panel.graphql';
import getPatientSearch from '../../../app/graphql/queries/get-patient-search.graphql';
import getPatientSocialSecurity from '../../../app/graphql/queries/get-patient-social-security.graphql';
import getPatient from '../../../app/graphql/queries/get-patient.graphql';
import patientForComputedList from '../../../app/graphql/queries/get-patients-for-computed-list.graphql';
import patientsNewToCareTeam from '../../../app/graphql/queries/get-patients-new-to-care-team.graphql';
import patientsWithAssignedState from '../../../app/graphql/queries/get-patients-with-assigned-state.graphql';
import patientsWithIntakeInProgress from '../../../app/graphql/queries/get-patients-with-intake-in-progress.graphql';
import patientsWithMissingInfo from '../../../app/graphql/queries/get-patients-with-missing-info.graphql';
import patientsWithNoRecentEngagement from '../../../app/graphql/queries/get-patients-with-no-recent-engagement.graphql';
import patientsWithOpenCBOReferrals from '../../../app/graphql/queries/get-patients-with-open-cbo-referrals.graphql';
import patientsWithOutOfDateMAP from '../../../app/graphql/queries/get-patients-with-out-of-date-map.graphql';
