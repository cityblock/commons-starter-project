begin;
truncate table task_template, patient_task_suggestion, question_condition, task_template, concern_suggestion, concern, answer, question, goal_suggestion_template, goal_suggestion, computed_field,  progress_note_template, risk_area, risk_area_group, screening_tool, screening_tool_score_range, task_suggestion, care_plan_suggestion, patient_concern, patient_answer, patient_goal, progress_note, risk_area_assessment_submission, patient_screening_tool_submission, care_plan_update_event, computed_field_flag, patient_answer_event, task, quick_call, task_event, task_comment, task_follower, event_notification;
