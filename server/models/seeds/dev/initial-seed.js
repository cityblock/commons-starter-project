  ...
  return knex
    ...
    .insert([
      ...
      buildPokemon(
        ...
        28,
        'fighting',
        ['Endure', 'Counter', 'Feint', 'Force Palm'],
        'https://cdn.bulbagarden.net/upload/a/a2/447Riolu.png',
      ),
      buildPokemon(
        'Lucario',
        448,
      ...
      buildPokemon(
        ...
        'https://cdn.bulbagarden.net/upload/thumb/d/dd/136Flareon.png/1200px-136Flareon.png',
      ),
      buildPokemon(
        'Jolteon',
        135,
        ...
        'electric',
        ['Discharge', 'Agility'],
        'https://cdn.bulbagarden.net/upload/thumb/b/bb/135Jolteon.png/1200px-135Jolteon.png',
      ),
      buildPokemon(
        'Vaporeon',
        134,
        ...
        'https://cdn.bulbagarden.net/upload/thumb/f/fd/134Vaporeon.png/1200px-134Vaporeon.png',
      ),
      buildPokemon(
        'Espeon',
        196,
        ...
        'psychic',
        ['Psybeam', 'Morning Sun'],
        'https://cdn.bulbagarden.net/upload/thumb/a/a7/196Espeon.png/1200px-196Espeon.png',
      ),
      buildPokemon(
        'Leafeon',
        470,
        ...
        59,
        'grass',
        ['Magical Leaf', 'Giga Drain'],
        'https://cdn.bulbagarden.net/upload/thumb/f/f5/470Leafeon.png/1200px-470Leafeon.png',
      ),
      buildPokemon(
        'Glaceon',
        471,
