...
export const ENGLISH_TRANSLATION = {
  ...
  messages: {
    ...
    'patientDocument.cityblockConsent': 'Click to sign the Consent to Treat form',
    'patientDocument.hipaaConsent': 'Click to sign the HIPAA consent form',
    'patientDocument.hieHealthixConsent': 'Click to sign the HIE/Healthix consent form',
    'patientDocument.hcp': 'Click to print the Health Care Proxy form',
