...
import {
  ...
  resolveRiskAreaGroupsForPatient,
...
const resolveFunctions = {
  RootQueryType: {
    ...
    riskAreaGroupsForPatient: resolveRiskAreaGroupsForPatient,
    ...
    calendarForCurrentUser: resolveCalendarForCurrentUser,
