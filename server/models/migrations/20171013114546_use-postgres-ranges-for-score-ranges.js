  ...
  return (
    knex.schema
      .alterTable('screening_tool_score_range', function(table) {
        table.dropIndex(
          ['screeningToolId', 'minimumScore', 'deletedAt'],
          'screening_tool_score_range_screeningtoolid_minimum_score',
        );
        table.dropIndex(
          ['screeningToolId', 'maximumScore', 'deletedAt'],
          'screening_tool_score_range_screeningtoolid_maximum_score',
        );
