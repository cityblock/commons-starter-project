...
export const ENGLISH_TRANSLATION = {
  ...
  messages: {
    ...
    'patientFilter.inNetwork': 'Patient In Network',
    'patientFilter.lineOfBusiness': 'Line of Business',
    'lineOfBusiness.placeholder': 'Select a line of business',
    'lineOfBusiness.hmo': 'HMO',
    'lineOfBusiness.medicaid': 'Medicaid',
    'lineOfBusiness.medicare': 'Medicare',
    'lineOfBusiness.ppo': 'PPO',
    'lineOfBusiness.ps': 'PS',
    'inNetwork.placeholder': 'Select if patient is in network',
    'inNetwork.yes': 'Yes',
    'inNetwork.no': 'No',
    ...
    'patientInfo.race': 'Self-indentifying race (select all that apply)',
    'patientInfo.raceFreeText': 'Self described race',
    'patientInfo.isHispanic': 'Are you of Hispanic, Latino or Spanish origin?',
    ...
    'coreIdentity.ssn': 'Social security number',
    'coreIdentity.cityblockId': 'Cityblock ID',
    'coreIdentity.nmi': 'Member ID (NMI)',
    'coreIdentity.mrn': 'MRN',
    'coreIdentity.placeholder': 'Select a field name...',
    'planInfo.placeholder': 'Select a field name...',
    ...
    'planInfo.medicaidPremiumGroup': 'Medicaid Premium Group',
    'planInfo.pcpName': 'PCP Name',
    'planInfo.pcpPractice': 'PCP Practice',
    'planInfo.pcpPhone': 'PCP Phone Number',
    'planInfo.pcpAddress': 'PCP Address',
    ...
    'patientExternalProvider.goToOrganizations': 'Go to organizations',
    ...
    'patientExternalOrganizationId.placeholder': 'Select organization',
    ...
    'patientTable.memberId': 'Cityblock ID',
    ...
    'patientTeam.externalOrganizationsEmptyTitle':
    ...
    'patientDocument.treatmentConsent': 'Click to sign the Consent to Treat form',
    'patientDocument.phiSharingConsent': 'Click to sign the authorization to share PHI',
    'patientDocument.hieHealthixConsent': 'Click to sign the Healthix consent form',
    'patientDocument.hcp': 'Click to sign the Health Care Proxy form',
    'patientDocument.privacyPracticesNotice': 'Click to sign the notice of privacy practices',
    'patientDocument.molst': 'Click to sign the MOLST',
    'patientDocument.textConsent': 'Click to sign the Text Messaging Consent form',
    'patientDocument.loading': 'Loading...',
    ...
    'documentType.hcp': 'Health care proxy form',
    'documentType.molst': 'MOLST form',
    'documentType.textConsent': 'Text message consent',
    'documentType.hra2010eApplication': '2010e application',
    'documentType.accessARideApplication': 'Access-a-ride application',
    'documentType.epicSeniorRxApplication': 'EPIC senior Rx application',
    'documentType.hieHealthixWithdrawal': 'Healthix withdrawal of consent form',
    'documentType.hieHealthixDenial': 'Healthix denial of consent form',
    'documentType.homecareReferral': 'Homecare referral',
    'documentType.homeHealthFacetoFaceCertification': 'Home health face to face certification',
    'documentType.m11q': 'M11Q',
    'documentType.map2015': 'MAP2015',
    'documentType.molstForDisabilities':
      'MOLST checklist for individuals with developmental disabilities',
    'documentType.privacyPracticesNotice': 'Notice of privacy practices',
    'documentType.socialSecurityDisability': 'Social security disability',
    ...
    'myTasks.priority': 'Priority',
    'myTasks.dueAt': 'Due date',
    'myTasks.patient': 'Patient',
    'myTasks.sortBy': 'Sort by:',
    'myTasks.assigned': 'Assigned',
    'myTasks.following': 'Following',
    'monthSelect.placeholder': 'Select a month...',
    'suggestionsSection.riskAreaAssessment': 'Manual Domain Assessments',
    'suggestionsSection.screeningTool': 'Screening Tools',
    'suggestionsSection.computedField': 'Automated Domain Assessments',
    'suggestionsGroup.concerns': 'Concerns:',
    'suggestionsGroup.goals': 'Goals:',
    'suggestionCategorySelect.riskAreaAssessment': 'Manual domains only',
    'suggestionCategorySelect.computedField': 'Automated domains only',
    'suggestionCategorySelect.screeningTool': 'Screening tools only',
    'suggestionCategorySelect.all': 'Show all sources',
    'suggestionCategorySelect.title': 'Suggestion source:',
    ...
    'settings.weekday0': 'Sunday',
    'settings.weekday1': 'Monday',
    'settings.weekday2': 'Tuesday',
    'settings.weekday3': 'Wednesday',
    'settings.weekday4': 'Thursday',
    'settings.weekday5': 'Friday',
    ...
    'race.isWhite': 'White',
    'race.isBlack': 'Black or African American',
    'race.isAmericanIndianAlaskan': 'American Indian and Alaska Native',
    'race.isAsian': 'Asian',
    'race.isHawaiianPacific': 'Native Hawaiian and Other Pacific Islander',
    'race.isOtherRace': 'Other',
    'isHispanic.true': 'Yes',
    'isHispanic.false': 'No',
    'isHispanic.placeholder': 'Select hispanic ethnicity...',
  },
};
