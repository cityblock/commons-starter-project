...
import currentUserEdit from '../../../app/graphql/queries/current-user-edit-mutation.graphql';
import getCurrentUser from '../../../app/graphql/queries/get-current-user.graphql';
import getUserSummaryList from '../../../app/graphql/queries/get-user-summary-list.graphql';
import getUsers from '../../../app/graphql/queries/get-users.graphql';
import getJwtForPdfCreate from '../../../app/graphql/queries/jwt-for-pdf-create.graphql';
import jwtForVcfCreate from '../../../app/graphql/queries/jwt-for-vcf-create.graphql';
import userLogin from '../../../app/graphql/queries/log-in-user-mutation.graphql';
import userCreate from '../../../app/graphql/queries/user-create-mutation.graphql';
import userDelete from '../../../app/graphql/queries/user-delete-mutation.graphql';
import userEditPermissions from '../../../app/graphql/queries/user-edit-permissions-mutation.graphql';
import userEditRole from '../../../app/graphql/queries/user-edit-role-mutation.graphql';
